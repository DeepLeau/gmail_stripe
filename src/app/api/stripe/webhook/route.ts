...
export async function POST(request: NextRequest) {
  ...
  // Client service_role casté en any pour éviter les erreurs TS "not assignable to never"
  // sur les INSERT/UPDATE/UPSERT. Acceptable ici car signature vérifiée et service_role bypass RLS.
