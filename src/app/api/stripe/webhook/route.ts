...
export async function POST(request: NextRequest) {
  ...
  // Client service_role pour le webhook — casté `as any` pour éviter les `never` sur les writes
  // Le webhook vérifie la signature Stripe avant toute écriture, et service_role bypass RLS
