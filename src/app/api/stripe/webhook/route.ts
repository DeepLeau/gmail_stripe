...
export async function POST(request: NextRequest) {
  ...
  // Cast as any requis pour permettre les INSERT/UPDATE/UPSERT en service_role
  // Acceptable uniquement ici car : signature vérifiée + service_role bypass RLS
  ...
  try {
    switch (event.type) {
      ...
      case 'customer.subscription.updated': {
        ...
        const subscription = rawSub as Stripe.Subscription & {
          current_period_start: number | null
          current_period_end: number | null
        }
