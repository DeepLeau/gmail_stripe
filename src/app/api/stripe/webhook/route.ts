...
export async function POST(request: NextRequest) {
  ...
  // Client service_role pour le webhook — bypass RLS
  // Cast 'as any' requis pour éviter les erreurs TS "not assignable to never"
  // sur les INSERT/UPDATE/UPSERT. Acceptable ici car :
  // 1. La signature Stripe est déjà vérifiée (auth en haut du handler)
  // 2. Service role bypass RLS de toute façon
