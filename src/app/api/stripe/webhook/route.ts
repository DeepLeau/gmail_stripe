  ...
  try {
    switch (event.type) {
      case 'checkout.session.completed': {
        ...
        const subscriptionWithPeriods = subscription as unknown as Stripe.Subscription & {
        ...
        const periodStart = subscriptionWithPeriods.current_period_start != null
          ? new Date(subscriptionWithPeriods.current_period_start * 1000).toISOString()
          : null
        const periodEnd = subscriptionWithPeriods.current_period_end != null
