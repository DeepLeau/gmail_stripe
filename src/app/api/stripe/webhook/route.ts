...
export async function POST(request: NextRequest) {
  ...
  // Cast as any requis ici pour permettre les INSERT/UPDATE/UPSERT sans erreur TS "never"
  // Le webhook a déjà vérifié la signature Stripe et utilise service_role (bypass RLS)
