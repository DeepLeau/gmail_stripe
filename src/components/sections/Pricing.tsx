...
const plans: Array<{
  ...
  },
  {
    ...
    price: '49 €',
    period: 'mois',
    description: 'Pour les équipes qui collaborent sur leurs emails.',
    features: [
...
export function Pricing() {
  const [loadingPlan, setLoadingPlan] = useState<StripePlanName | null>(null)
  const [errorPlan, setErrorPlan] = useState<StripePlanName | null>(null)

  async function handleCheckout(plan: StripePlanName) {
    setLoadingPlan(plan)
    setErrorPlan(null)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          {plans.map((plan, i) => {
            ...
            const hasError = errorPlan === plan.plan
            ...
            return (
              ...
              >
                {/* Error message */}
                {hasError && (
                  <p className="text-xs text-center py-2 px-3 rounded-lg bg-red-50 border border-red-200 text-red-600">
