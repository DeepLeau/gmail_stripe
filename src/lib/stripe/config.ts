...
// ─── PLAN_LIMITS — alias typé pour compatibilité avec les consommateurs existants ──
export const PLAN_LIMITS: Record<StripePlanName, PlanConfig> = PLANS
...
export const UNIT_LABEL_PLURAL = 'units'
