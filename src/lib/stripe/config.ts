...
// ─── Type des plans ─────────────────────────────────────────────────────────
export type StripePlanName = 'start' | 'scale' | 'enterprise'
...
const PLANS: Record<StripePlanName, PlanConfig> = {
  ...
  enterprise: { id: 'enterprise', priceId: process.env.STRIPE_ENTERPRISE_PRICE_ID ?? '', unitsLimit: 100, displayName: 'Enterprise' },
}
...
export const UNIT_LABEL = 'response'
export const UNIT_LABEL_PLURAL = 'responses'
